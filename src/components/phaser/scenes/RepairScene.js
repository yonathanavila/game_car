...
export default class RepairScene extends Phaser.Scene {
  ...
  create() {
    ...
    const closeButton = this.add
      .image(this.sys.game.config.width - 125, 50, "close")
    ...
    const tool_3 = this.add
      .image(370, this.sys.game.config.height - 245, "tool_3")
      .setOrigin(0, 0);
    tool_3.displayHeight = 150;
    tool_3.displayWidth = 30;

    const tool_4 = this.add
      .image(35, this.sys.game.config.height - 100, "tool_4")
      .setOrigin(0, 0);
    ...
    const lowerBallJointInfo = this.damageInfo.find(
    ...
    const shockAbsorber = this.damageInfo.find(
    ...
    const aligmentBalance = this.damageInfo.find(
    ...
    const brakeCheckService = this.damageInfo.find(
    ...
    const checkAirPressure = this.damageInfo.find(
